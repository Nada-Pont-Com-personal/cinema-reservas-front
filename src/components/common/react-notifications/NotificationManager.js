...
class NotificationManager extends EventEmitter {
  ...
  successReduzida(message, timeOut, customClassName, title, onClick, priority) {
    this.create({
      type: Constants.SUCCESS,
      message,
      title,
  ...
  warningReduzida(message, timeOut, customClassName, title, onClick, priority) {
    this.create({
      type: Constants.WARNING,
      message,
      title,
  ...
  errorReduzida(message, timeOut, customClassName, title, onClick, priority) {
    this.create({
      type: Constants.ERROR,
      message,
      title,
